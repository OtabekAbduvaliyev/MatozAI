...
const HistoryList: React.FC<HistoryListProps> = ({ items, onDelete, onCopy }) => {
  if (items.length === 0) return null;

  return (
    <div className="w-full max-w-2xl mt-12 px-6 pb-24 border-t border-slate-100 pt-8">
      <h3 className="text-xs font-mono uppercase tracking-widest text-slate-400 mb-6">Saved Sessions</h3>
