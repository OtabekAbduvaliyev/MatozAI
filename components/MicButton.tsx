...
const MicButton: React.FC<MicButtonProps> = ({ isRecording, isProcessing, onClick }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <div className={`
            absolute inset-0 bg-white opacity-0 rounded-[2rem] transition-opacity duration-500
